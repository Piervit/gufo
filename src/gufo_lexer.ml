...
(*    | "_"      -> Gufo_parser.JOKER   *)
   ...
   | ">."      -> Gufo_parser.CLOSING_CHEVRON_DOT  , (Sedlexing.lexing_positions lexbuf)
   ...
   | "<."      -> Gufo_parser.OPENING_CHEVRON_DOT  , (Sedlexing.lexing_positions lexbuf)
   ...
   | "<=."     -> Gufo_parser.EQ_OPENING_CHEVRON_DOT, (Sedlexing.lexing_positions lexbuf)
   | ">="     -> Gufo_parser.EQ_CLOSING_CHEVRON, (Sedlexing.lexing_positions lexbuf)
   | ">=."     -> Gufo_parser.EQ_CLOSING_CHEVRON_DOT, (Sedlexing.lexing_positions lexbuf)
